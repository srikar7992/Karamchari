...
| H-1 | High | No event schema versioning/compatibility gate | 4 | Platform | **IN PROGRESS** — [event-versioning standard](docs/development/standards/event-versioning-standard.md) written; CI compat gate + arch test pending |
