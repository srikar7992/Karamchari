...
| H-2 | High | No saga/compensation for cross-module flows | 5 | Platform | **DISCOVERY COMPLETE — IMPL PENDING** — [SagaCandidateAssessment](docs/architecture/SagaCandidateAssessment.md) maps the event graph + 4-gate analysis; 4 sagas recommended (EmployeeOnboarding P1, Offboarding P2, Disbursement P3, BenefitsEnrollment P4). Implement after approval, P1 first |
