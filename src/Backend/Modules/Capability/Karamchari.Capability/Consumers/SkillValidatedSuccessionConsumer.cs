...
/// <summary>
/// MassTransit consumer that recomputes <see cref="Domain.Succession.SuccessorCandidateProjection"/>
/// rows whenever a skill is validated for an employee.
/// </summary>
public sealed class SkillValidatedSuccessionConsumer(SuccessorCandidateProjectionHandler handler)
