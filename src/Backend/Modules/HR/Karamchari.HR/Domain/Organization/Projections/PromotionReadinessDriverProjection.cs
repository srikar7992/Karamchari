// -----------------------------------------------------------------------
// <copyright file="PromotionReadinessDriverProjection.cs" company="Karamchari">
...
/// <summary>
/// Read model representing a specific development factor/driver contributing to an employee's promotion readiness.
/// </summary>
public sealed class PromotionReadinessDriverProjection
{
    ...
    /// <summary>Gets or sets the type of readiness driver factor.</summary>
    public PromotionReadinessDriverType DriverType { get; set; }
