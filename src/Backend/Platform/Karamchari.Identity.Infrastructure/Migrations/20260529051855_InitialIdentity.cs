        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RevokedAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    ExpiresAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SecurityAuditEntries_TenantId",
                schema: "identity",
                table: "SecurityAuditEntries",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_SecurityAuditEntries_TimestampUtc",
                schema: "identity",
                table: "SecurityAuditEntries",
                column: "TimestampUtc");

            migrationBuilder.CreateIndex(
                name: "IX_SecurityAuditEntries_UserId",
                schema: "identity",
                table: "SecurityAuditEntries",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_SigningKeys_ActivatedAt",
                schema: "identity",
                table: "SigningKeys",
                column: "ActivatedAt");
        }
