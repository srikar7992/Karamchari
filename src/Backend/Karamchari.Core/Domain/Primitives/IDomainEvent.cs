...
/// and persisted to the tenant outbox table within the same transaction —
/// MassTransit publishes them downstream.
/// </summary>
public interface IDomainEvent
{
    /// <summary>Stable identifier for the event instance — used as the idempotency key downstream.</summary>
    Guid EventId { get; }
