...
# Require password via env var — never hardcode credentials in this script.
if [ -z "${ADMIN_PASSWORD:-}" ]; then
    echo "ADMIN_PASSWORD env var required for certification script."
    exit 1
fi
